...
public class Walk_mac_address {

    static ArrayList<String> snmp_mac_address = new ArrayList<String>();

    static ArrayList<String> snmp_mac_port = new ArrayList<String>();
